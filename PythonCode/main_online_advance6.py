...
#        print 'trainIDSet final: ',trainIDSetFinal
    ...
    plt.plot(range(len(listEstMSERRank)), listEstMSERRank,'rx', label = 'Online regression interacting model (3)')                 
    plt.plot(range(len(listEstSimMSERRank)), listEstMSERRank,'b+', label = 'Online regression model (7)')                    
